---
story_number: 1
title: "Gestión de cuentas financieras con notas débito y crédito"
slug: "gestion-cuentas-financieras"
estado: "Sliceada"
...
slicing_justificacion: "CRUD de cuentas y CRUD de notas son recursos independientes (cada uno con endpoints, validaciones y tabla propios); el análisis INVEST marcó Small 5/10. Corte por funcionalidad: US-001.1 (cuentas) y US-001.2 (notas)"
slicing_hijas: ["1.1", "1.2"]
...
# Historia #1: Gestión de cuentas financieras con notas débito y crédito
